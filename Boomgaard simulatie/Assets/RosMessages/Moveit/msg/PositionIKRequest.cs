...
namespace RosMessageTypes.Moveit
{
    public class PositionIKRequest : Message
    {
        ...
        public Geometry.PoseStamped[] pose_stamped_vector;
        ...
        public PositionIKRequest()
        {
            ...
            this.ik_link_name = "";
            this.pose_stamped = new Geometry.PoseStamped();
            this.ik_link_names = new string[0];
            this.pose_stamped_vector = new Geometry.PoseStamped[0];
            this.timeout = new Duration();
        }

        public PositionIKRequest(string group_name, RobotState robot_state, Constraints constraints, bool avoid_collisions, string ik_link_name, Geometry.PoseStamped pose_stamped, string[] ik_link_names, Geometry.PoseStamped[] pose_stamped_vector, Duration timeout)
        {
        ...
        public override int Deserialize(byte[] data, int offset)
        {
            ...
            offset += 4;
            this.pose_stamped_vector= new Geometry.PoseStamped[pose_stamped_vectorArrayLength];
            for(var i = 0; i < pose_stamped_vectorArrayLength; i++)
            {
                this.pose_stamped_vector[i] = new Geometry.PoseStamped();
