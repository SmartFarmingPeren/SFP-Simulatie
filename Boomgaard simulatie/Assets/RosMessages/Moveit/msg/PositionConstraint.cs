...
namespace RosMessageTypes.Moveit
{
    public class PositionConstraint : Message
    {
        ...
        public Geometry.Vector3 target_point_offset;
        ...
        public PositionConstraint()
        {
            ...
            this.link_name = "";
            this.target_point_offset = new Geometry.Vector3();
            this.constraint_region = new BoundingVolume();
            this.weight = 0.0;
        }

        public PositionConstraint(Header header, string link_name, Geometry.Vector3 target_point_offset, BoundingVolume constraint_region, double weight)
        {
            this.header = header;
