...
namespace RosMessageTypes.Moveit
{
    public class VisibilityConstraint : Message
    {
        ...
        public Geometry.PoseStamped target_pose;
        ...
        public Geometry.PoseStamped sensor_pose;
        ...
        public VisibilityConstraint()
        {
            ...
            this.target_pose = new Geometry.PoseStamped();
            this.cone_sides = 0;
            this.sensor_pose = new Geometry.PoseStamped();
        ...
        public VisibilityConstraint(double target_radius, Geometry.PoseStamped target_pose, int cone_sides, Geometry.PoseStamped sensor_pose, double max_view_angle, double max_range_angle, byte sensor_view_direction, double weight)
        {
        ...
        public override List<byte[]> SerializationStatements()
        {
            ...
            listOfSerializations.Add(new[]{this.sensor_view_direction});
