...
namespace RosMessageTypes.Moveit
{
    public class WorkspaceParameters : Message
    {
        ...
        public Geometry.Vector3 min_corner;
        //  The maximum corner of the box, with respect to the robot starting pose
        public Geometry.Vector3 max_corner;

        public WorkspaceParameters()
        {
            this.header = new Header();
            this.min_corner = new Geometry.Vector3();
            this.max_corner = new Geometry.Vector3();
        }

        public WorkspaceParameters(Header header, Geometry.Vector3 min_corner, Geometry.Vector3 max_corner)
        {
            this.header = header;
