...
namespace RosMessageTypes.Moveit
{
    public class PlanningScene : Message
    {
        ...
        public Geometry.TransformStamped[] fixed_frame_transforms;
        ...
        public PlanningScene()
        {
            ...
            this.fixed_frame_transforms = new Geometry.TransformStamped[0];
        ...
        public PlanningScene(string name, RobotState robot_state, string robot_model_name, Geometry.TransformStamped[] fixed_frame_transforms, AllowedCollisionMatrix allowed_collision_matrix, LinkPadding[] link_padding, LinkScale[] link_scale, ObjectColor[] object_colors, PlanningSceneWorld world, bool is_diff)
        {
            this.name = name;
        ...
        public override int Deserialize(byte[] data, int offset)
        {
            ...
            offset += 4;
            this.fixed_frame_transforms= new Geometry.TransformStamped[fixed_frame_transformsArrayLength];
            for(var i = 0; i < fixed_frame_transformsArrayLength; i++)
            {
                this.fixed_frame_transforms[i] = new Geometry.TransformStamped();
