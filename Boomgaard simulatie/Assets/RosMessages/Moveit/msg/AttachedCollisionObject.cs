...
namespace RosMessageTypes.Moveit
{
    public class AttachedCollisionObject : Message
    {
        ...
        public AttachedCollisionObject()
        {
            ...
            this.detach_posture = new Trajectory.JointTrajectory();
            this.weight = 0.0;
        }

        public AttachedCollisionObject(string link_name, CollisionObject @object, string[] touch_links, Trajectory.JointTrajectory detach_posture, double weight)
        {
